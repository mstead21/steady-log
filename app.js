...
(() => {
  ...
  const EX_LIBRARY = [
    { name:"Smith Incline Bench Press", video:"smith machine incline bench press form", tags:["chest","press","upper"] },
    { name:"Incline Dumbbell Press", video:"incline dumbbell press form", tags:["chest","press","upper"] },
    { name:"Chest Press (Plate Loaded Flat)", video:"plate loaded chest press machine form", tags:["chest","press"] },
    { name:"Chest Supported Row Machine (Plate)", video:"chest supported row machine plate loaded form", tags:["back","row"] },
    { name:"Seated Cable Row", video:"seated cable row form", tags:["back","row"] },
    { name:"Lat Pulldown", video:"lat pulldown form", tags:["back","lats"] },
    { name:"Face Pull", video:"face pull form", tags:["rear delts","shoulders"] },
    { name:"Dumbbell Lateral Raise", video:"dumbbell lateral raise form", tags:["shoulders"] },
    { name:"Shoulder Press (Plate Machine)", video:"plate loaded shoulder press machine form", tags:["shoulders","press"] },
    { name:"Cable Tricep Pushdown", video:"cable tricep pushdown form", tags:["triceps","arms"] },
    { name:"Preacher Curl Machine", video:"preacher curl machine form", tags:["biceps","arms"] },
    { name:"45° Leg Press", video:"45 degree leg press form", tags:["legs","quads"] },
    { name:"Leg Extension", video:"leg extension machine form", tags:["legs","quads"] },
    { name:"Seated Hamstring Curl", video:"seated leg curl form", tags:["legs","hamstrings"] },
    { name:"Lying Hamstring Curl", video:"lying leg curl form", tags:["legs","hamstrings"] },
    { name:"Romanian Deadlift (DB/BB)", video:"romanian deadlift form", tags:["hamstrings","glutes"] },
    { name:"Hip Thrust", video:"hip thrust form", tags:["glutes"] },
    { name:"Standing Calf Raise", video:"standing calf raise machine form", tags:["calves"] },
    { name:"Hip Abductor", video:"hip abductor machine form", tags:["glutes","hips"] },
  ];

  const DEFAULT_TEMPLATES = [
    { id:"upperA", name:"Upper A", subtitle:"Chest & Arms",
      exercises:[
        { id:"smith_incline", name:"Smith Incline Bench Press", sets:3, reps:"6–8",  rest:120, video:"smith machine incline bench press form" },
        { id:"row_cs", name:"Chest Supported Row Machine (Plate)", sets:3, reps:"8–12", rest:90,  video:"chest supported row machine plate loaded form" },
        { id:"chest_press", name:"Chest Press (Plate Loaded Flat)", sets:3, reps:"8–10", rest:90,  video:"plate loaded chest press machine form" },
        { id:"shoulder_press", name:"Shoulder Press (Plate Machine)", sets:3, reps:"8–10", rest:90,  video:"plate loaded shoulder press machine form" },
        { id:"tri_pushdown", name:"Cable Tricep Pushdown", sets:3, reps:"10–15", rest:60, video:"cable tricep pushdown form" },
        { id:"preacher", name:"Preacher Curl Machine", sets:3, reps:"10–15", rest:60, video:"preacher curl machine form" },
      ]
    },
    { id:"lowerA", name:"Lower A", subtitle:"Quads & Burn",
      exercises:[
        { id:"leg_press", name:"45° Leg Press", sets:4, reps:"8–12", rest:120, video:"45 degree leg press form" },
        { id:"leg_ext", name:"Leg Extension", sets:3, reps:"12–15", rest:75, video:"leg extension machine form" },
        { id:"ham_curl", name:"Seated Hamstring Curl", sets:3, reps:"10–15", rest:75, video:"seated leg curl form" },
        { id:"calves", name:"Standing Calf Raise", sets:4, reps:"10–15", rest:60, video:"standing calf raise machine form" },
      ]
    },
    { id:"upperB", name:"Upper B", subtitle:"Back & Shoulders",
      exercises:[
        { id:"lat_pd", name:"Lat Pulldown", sets:4, reps:"8–12", rest:90, video:"lat pulldown form" },
        { id:"row_cable", name:"Seated Cable Row", sets:3, reps:"8–12", rest:90, video:"seated cable row form" },
        { id:"incl_db", name:"Incline Dumbbell Press", sets:3, reps:"8–12", rest:90, video:"incline dumbbell press form" },
        { id:"lat_raise", name:"Dumbbell Lateral Raise", sets:3, reps:"12–20", rest:60, video:"dumbbell lateral raise form" },
        { id:"facepull", name:"Face Pull", sets:3, reps:"12–20", rest:60, video:"face pull form" },
      ]
    },
    { id:"lowerB", name:"Lower B", subtitle:"Hamstrings & Glutes",
      exercises:[
        { id:"rdl", name:"Romanian Deadlift (DB/BB)", sets:4, reps:"6–10", rest:120, video:"romanian deadlift form" },
        { id:"hip_thrust", name:"Hip Thrust", sets:4, reps:"8–12", rest:120, video:"hip thrust form" },
        { id:"ham_curl2", name:"Lying Hamstring Curl", sets:3, reps:"10–15", rest:75, video:"lying leg curl form" },
